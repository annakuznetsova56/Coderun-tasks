...
Движения — это строка с символами **U, R, L, D** для направления движения (вверх, вправо, влево, вниз) и числами, отображающими количество шагов в нужном направлении.
